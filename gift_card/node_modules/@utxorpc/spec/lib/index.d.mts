...
declare class Redeemer extends Message<Redeemer> {
     ...
     */
    originalCbor: Uint8Array<ArrayBuffer>;
...
declare class Withdrawal extends Message<Withdrawal> {
     ...
     */
    rewardAccount: Uint8Array<ArrayBuffer>;
    /**
 ...
 */
declare class GovernanceActionProposal extends Message<GovernanceActionProposal> {
    /**
 ...
 */
declare class GovernanceAction extends Message<GovernanceAction> {
    /**
 ...
 */
declare class GovernanceActionId extends Message<GovernanceActionId> {
    /**
     * @generated from field: bytes transaction_id = 1;
     */
    transactionId: Uint8Array<ArrayBuffer>;
    /**
     * @generated from field: uint32 governance_action_index = 2;
     */
    governanceActionIndex: number;
 ...
 */
declare class ParameterChangeAction extends Message<ParameterChangeAction> {
    /**
     ...
     */
    policyHash: Uint8Array<ArrayBuffer>;
 ...
 */
declare class HardForkInitiationAction extends Message<HardForkInitiationAction> {
    /**
     * @generated from field: utxorpc.v1alpha.cardano.GovernanceActionId gov_action_id = 1;
     */
    govActionId?: GovernanceActionId;
 ...
 */
declare class TreasuryWithdrawalsAction extends Message<TreasuryWithdrawalsAction> {
    /**
 ...
 */
declare class WithdrawalAmount extends Message<WithdrawalAmount> {
    /**
     * @generated from field: bytes reward_account = 1;
     */
    rewardAccount: Uint8Array<ArrayBuffer>;
 ...
 */
declare class NoConfidenceAction extends Message<NoConfidenceAction> {
    /**
     * @generated from field: utxorpc.v1alpha.cardano.GovernanceActionId gov_action_id = 1;
     */
    govActionId?: GovernanceActionId;
 ...
 */
declare class UpdateCommitteeAction extends Message<UpdateCommitteeAction> {
    /**
     * @generated from field: utxorpc.v1alpha.cardano.GovernanceActionId gov_action_id = 1;
     */
    govActionId?: GovernanceActionId;
 ...
 */
declare class NewConstitutionAction extends Message<NewConstitutionAction> {
    /**
     * @generated from field: utxorpc.v1alpha.cardano.GovernanceActionId gov_action_id = 1;
     */
    govActionId?: GovernanceActionId;
 ...
 */
declare class Constitution extends Message<Constitution> {
    /**
 ...
 */
declare class NewCommitteeCredentials extends Message<NewCommitteeCredentials> {
    /**
...
declare class Relay extends Message<Relay> {
     ...
     */
    ipV4: Uint8Array<ArrayBuffer>;
    /**
     * @generated from field: bytes ip_v6 = 2;
     */
    ipV6: Uint8Array<ArrayBuffer>;
    /**
...
declare class StakeDelegationCert extends Message<StakeDelegationCert> {
     ...
     */
    poolKeyhash: Uint8Array<ArrayBuffer>;
...
declare class PoolRegistrationCert extends Message<PoolRegistrationCert> {
     ...
     */
    operator: Uint8Array<ArrayBuffer>;
    /**
     * VRF key hash.
     *
     * @generated from field: bytes vrf_keyhash = 2;
     */
    vrfKeyhash: Uint8Array<ArrayBuffer>;
    /**
     * Pledge amount.
     *
...
declare class GenesisKeyDelegationCert extends Message<GenesisKeyDelegationCert> {
     ...
     */
    genesisHash: Uint8Array<ArrayBuffer>;
    /**
     * Genesis delegate hash.
     *
     * @generated from field: bytes genesis_delegate_hash = 2;
     */
    genesisDelegateHash: Uint8Array<ArrayBuffer>;
    /**
     * VRF key hash.
     *
...
declare class AddressPattern extends Message<AddressPattern> {
     ...
     */
    exactAddress: Uint8Array<ArrayBuffer>;
    /**
 ...
 */
declare class VotingThresholds extends Message<VotingThresholds> {
    /**
...
type cardano_pb_Constitution = Constitution;
declare const cardano_pb_Constitution: typeof Constitution;
...
type cardano_pb_GovernanceAction = GovernanceAction;
declare const cardano_pb_GovernanceAction: typeof GovernanceAction;
type cardano_pb_GovernanceActionId = GovernanceActionId;
declare const cardano_pb_GovernanceActionId: typeof GovernanceActionId;
type cardano_pb_GovernanceActionProposal = GovernanceActionProposal;
declare const cardano_pb_GovernanceActionProposal: typeof GovernanceActionProposal;
type cardano_pb_HardForkInitiationAction = HardForkInitiationAction;
declare const cardano_pb_HardForkInitiationAction: typeof HardForkInitiationAction;
...
type cardano_pb_NewCommitteeCredentials = NewCommitteeCredentials;
declare const cardano_pb_NewCommitteeCredentials: typeof NewCommitteeCredentials;
type cardano_pb_NewConstitutionAction = NewConstitutionAction;
declare const cardano_pb_NewConstitutionAction: typeof NewConstitutionAction;
type cardano_pb_NoConfidenceAction = NoConfidenceAction;
declare const cardano_pb_NoConfidenceAction: typeof NoConfidenceAction;
type cardano_pb_PParams = PParams;
declare const cardano_pb_PParams: typeof PParams;
type cardano_pb_ParameterChangeAction = ParameterChangeAction;
declare const cardano_pb_ParameterChangeAction: typeof ParameterChangeAction;
...
type cardano_pb_TreasuryWithdrawalsAction = TreasuryWithdrawalsAction;
declare const cardano_pb_TreasuryWithdrawalsAction: typeof TreasuryWithdrawalsAction;
...
type cardano_pb_UpdateCommitteeAction = UpdateCommitteeAction;
declare const cardano_pb_UpdateCommitteeAction: typeof UpdateCommitteeAction;
...
type cardano_pb_VotingThresholds = VotingThresholds;
declare const cardano_pb_VotingThresholds: typeof VotingThresholds;
type cardano_pb_Withdrawal = Withdrawal;
declare const cardano_pb_Withdrawal: typeof Withdrawal;
type cardano_pb_WithdrawalAmount = WithdrawalAmount;
declare const cardano_pb_WithdrawalAmount: typeof WithdrawalAmount;
type cardano_pb_WitnessSet = WitnessSet;
declare const cardano_pb_WitnessSet: typeof WitnessSet;
declare namespace cardano_pb {
  export { cardano_pb_AddressPattern as AddressPattern, cardano_pb_Anchor as Anchor, cardano_pb_Asset as Asset, cardano_pb_AssetPattern as AssetPattern, cardano_pb_AuthCommitteeHotCert as AuthCommitteeHotCert, cardano_pb_AuxData as AuxData, cardano_pb_BigInt as BigInt, cardano_pb_Block as Block, cardano_pb_BlockBody as BlockBody, cardano_pb_BlockHeader as BlockHeader, cardano_pb_Certificate as Certificate, cardano_pb_Collateral as Collateral, cardano_pb_Constitution as Constitution, cardano_pb_Constr as Constr, cardano_pb_CostModel as CostModel, cardano_pb_CostModels as CostModels, cardano_pb_DRep as DRep, cardano_pb_Datum as Datum, cardano_pb_EvalError as EvalError, cardano_pb_EvalTrace as EvalTrace, cardano_pb_ExPrices as ExPrices, cardano_pb_ExUnits as ExUnits, cardano_pb_GenesisKeyDelegationCert as GenesisKeyDelegationCert, cardano_pb_GovernanceAction as GovernanceAction, cardano_pb_GovernanceActionId as GovernanceActionId, cardano_pb_GovernanceActionProposal as GovernanceActionProposal, cardano_pb_HardForkInitiationAction as HardForkInitiationAction, cardano_pb_Metadata as Metadata, cardano_pb_Metadatum as Metadatum, cardano_pb_MetadatumArray as MetadatumArray, cardano_pb_MetadatumMap as MetadatumMap, cardano_pb_MetadatumPair as MetadatumPair, cardano_pb_MirCert as MirCert, cardano_pb_MirSource as MirSource, cardano_pb_MirTarget as MirTarget, cardano_pb_Multiasset as Multiasset, cardano_pb_NativeScript as NativeScript, cardano_pb_NativeScriptList as NativeScriptList, cardano_pb_NewCommitteeCredentials as NewCommitteeCredentials, cardano_pb_NewConstitutionAction as NewConstitutionAction, cardano_pb_NoConfidenceAction as NoConfidenceAction, cardano_pb_PParams as PParams, cardano_pb_ParameterChangeAction as ParameterChangeAction, cardano_pb_PlutusData as PlutusData, cardano_pb_PlutusDataArray as PlutusDataArray, cardano_pb_PlutusDataMap as PlutusDataMap, cardano_pb_PlutusDataPair as PlutusDataPair, cardano_pb_PoolMetadata as PoolMetadata, cardano_pb_PoolRegistrationCert as PoolRegistrationCert, cardano_pb_PoolRetirementCert as PoolRetirementCert, cardano_pb_ProtocolVersion as ProtocolVersion, cardano_pb_RationalNumber as RationalNumber, cardano_pb_Redeemer as Redeemer, cardano_pb_RedeemerPurpose as RedeemerPurpose, cardano_pb_RegCert as RegCert, cardano_pb_RegDRepCert as RegDRepCert, cardano_pb_Relay as Relay, cardano_pb_ResignCommitteeColdCert as ResignCommitteeColdCert, cardano_pb_Script as Script, cardano_pb_ScriptNOfK as ScriptNOfK, cardano_pb_StakeCredential as StakeCredential, cardano_pb_StakeDelegationCert as StakeDelegationCert, cardano_pb_StakeRegDelegCert as StakeRegDelegCert, cardano_pb_StakeVoteDelegCert as StakeVoteDelegCert, cardano_pb_StakeVoteRegDelegCert as StakeVoteRegDelegCert, cardano_pb_TreasuryWithdrawalsAction as TreasuryWithdrawalsAction, cardano_pb_Tx as Tx, cardano_pb_TxEval as TxEval, cardano_pb_TxInput as TxInput, cardano_pb_TxOutput as TxOutput, cardano_pb_TxOutputPattern as TxOutputPattern, cardano_pb_TxPattern as TxPattern, cardano_pb_TxValidity as TxValidity, cardano_pb_UnRegCert as UnRegCert, cardano_pb_UnRegDRepCert as UnRegDRepCert, cardano_pb_UpdateCommitteeAction as UpdateCommitteeAction, cardano_pb_UpdateDRepCert as UpdateDRepCert, cardano_pb_VKeyWitness as VKeyWitness, cardano_pb_VoteDelegCert as VoteDelegCert, cardano_pb_VoteRegDelegCert as VoteRegDelegCert, cardano_pb_VotingThresholds as VotingThresholds, cardano_pb_Withdrawal as Withdrawal, cardano_pb_WithdrawalAmount as WithdrawalAmount, cardano_pb_WitnessSet as WitnessSet };
}
 ...
 *
 * @generated from message utxorpc.v1alpha.sync.ReadTipRequest
 */
declare class ReadTipRequest extends Message<ReadTipRequest> {
    constructor(data?: PartialMessage<ReadTipRequest>);
    static readonly runtime: typeof proto3;
    static readonly typeName = "utxorpc.v1alpha.sync.ReadTipRequest";
    static readonly fields: FieldList;
    static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ReadTipRequest;
    static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ReadTipRequest;
    static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ReadTipRequest;
    static equals(a: ReadTipRequest | PlainMessage<ReadTipRequest> | undefined, b: ReadTipRequest | PlainMessage<ReadTipRequest> | undefined): boolean;
}
/**
 * Response containing the current tip of the blockchain.
 *
 * @generated from message utxorpc.v1alpha.sync.ReadTipResponse
 */
declare class ReadTipResponse extends Message<ReadTipResponse> {
    /**
     * The current tip of the blockchain.
     *
     * @generated from field: utxorpc.v1alpha.sync.BlockRef tip = 1;
     */
    tip?: BlockRef$1;
    constructor(data?: PartialMessage<ReadTipResponse>);
    static readonly runtime: typeof proto3;
    static readonly typeName = "utxorpc.v1alpha.sync.ReadTipResponse";
    static readonly fields: FieldList;
    static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ReadTipResponse;
    static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ReadTipResponse;
    static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ReadTipResponse;
    static equals(a: ReadTipResponse | PlainMessage<ReadTipResponse> | undefined, b: ReadTipResponse | PlainMessage<ReadTipResponse> | undefined): boolean;
}
...
type sync_pb_ReadTipRequest = ReadTipRequest;
declare const sync_pb_ReadTipRequest: typeof ReadTipRequest;
type sync_pb_ReadTipResponse = ReadTipResponse;
declare const sync_pb_ReadTipResponse: typeof ReadTipResponse;
declare namespace sync_pb {
  export { sync_pb_AnyChainBlock as AnyChainBlock, BlockRef$1 as BlockRef, sync_pb_DumpHistoryRequest as DumpHistoryRequest, sync_pb_DumpHistoryResponse as DumpHistoryResponse, sync_pb_FetchBlockRequest as FetchBlockRequest, sync_pb_FetchBlockResponse as FetchBlockResponse, sync_pb_FollowTipRequest as FollowTipRequest, sync_pb_FollowTipResponse as FollowTipResponse, sync_pb_ReadTipRequest as ReadTipRequest, sync_pb_ReadTipResponse as ReadTipResponse };
}
...
declare const SyncService: {
    ...
    readonly methods: {
         ...
         */
        readonly readTip: {
            readonly name: "ReadTip";
            readonly I: typeof ReadTipRequest;
            readonly O: typeof ReadTipResponse;
            readonly kind: MethodKind.Unary;
        };
    };
};
