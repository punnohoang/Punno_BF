...
declare class Web3Wallet {
    ...
    signData(payload: string, address?: string): Promise<DataSignature | string>;
    /**
     ...
     */
    static initWallet({ networkId, address, fetcher, submitter, projectId, appUrl, user, chain, }: {
        networkId: 0 | 1;
        address: string;
        fetcher?: IFetcher;
        submitter?: ISubmitter;
...
export { ApiError, AuthRouteError, type CreateDeviceBody, type CreateDeviceResponse, type CreateWalletBody, type CreateWalletResponseBody, type EnableWeb3WalletOptions, type GetDevicesResponse, type GetWalletBody, NotAuthenticatedError, type OpenWindowParams, type OpenWindowResult, SessionExpiredError, type SponsorshipTxParserPostRequestBody, StorageInsertError, type StorageLocation, StorageRetrievalError, type UserControlledWalletDirectTo, type UserSocialData, type UserWalletSettings, type UserWalletSettingsWallet, type WalletDevice, WalletServerCreationError, WalletServerRetrievalError, type Web3AuthProvider, type Web3JWTBody, Web3NonCustodialProvider, type Web3NonCustodialProviderParams, type Web3NonCustodialProviderUser, type Web3NonCustodialWallet, type Web3Project, type Web3ProjectBranding, type Web3ProjectWallet, Web3Sdk, Web3Wallet, type Web3WalletObject, type Web3WalletRecovery, type WindowSignDataReq, type WindowSignDataRes, type WindowSignTxReq, type WindowSignTxRes, type WindowWalletReq, type WindowWalletRes, bytesToHex, bytesToString, clientDeriveWallet, clientGenerateWallet, clientRecovery, combineShardsBuildWallet, crypto, decryptWithCipher, decryptWithPrivateKey, encryptWithCipher, encryptWithPublicKey, generateHash, generateKeyPair, getAddressFromHashes, hashData, hexToBytes, meshUniversalStaticUtxo, openWindow, shamirCombine, shamirSplit, spiltKeyIntoShards, stringToBytes };
