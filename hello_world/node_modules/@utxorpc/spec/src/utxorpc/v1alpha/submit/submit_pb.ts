...
import { Tx, TxEval, TxPattern } from "../cardano/cardano_pb.js";
 ...
 */
export class EvalTxRequest extends Message<EvalTxRequest> {
  /**
  ...
  static equals(a: EvalTxRequest | PlainMessage<EvalTxRequest> | undefined, b: EvalTxRequest | PlainMessage<EvalTxRequest> | undefined): boolean {
    return proto3.util.equals(EvalTxRequest, a, b);
  }
}
 ...
 */
export class AnyChainEval extends Message<AnyChainEval> {
  /**
  ...
  static equals(a: AnyChainEval | PlainMessage<AnyChainEval> | undefined, b: AnyChainEval | PlainMessage<AnyChainEval> | undefined): boolean {
    return proto3.util.equals(AnyChainEval, a, b);
  }
}
 ...
 */
export class EvalTxResponse extends Message<EvalTxResponse> {
  /**
  ...
  static equals(a: EvalTxResponse | PlainMessage<EvalTxResponse> | undefined, b: EvalTxResponse | PlainMessage<EvalTxResponse> | undefined): boolean {
    return proto3.util.equals(EvalTxResponse, a, b);
  }
}
...
export class TxInMempool extends Message<TxInMempool> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "native_bytes", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 3, name: "stage", kind: "enum", T: proto3.getEnumType(Stage) },
