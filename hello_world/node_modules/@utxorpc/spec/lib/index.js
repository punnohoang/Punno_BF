...
__export(index_exports, {
  cardano: () => cardano_pb_exports,
  query: () => query_pb_exports,
  queryConnect: () => query_connect_exports,
  submit: () => submit_pb_exports,
  submitConnect: () => submit_connect_exports,
  sync: () => sync_pb_exports,
  syncConnect: () => sync_connect_exports,
  watch: () => watch_pb_exports,
  watchConnect: () => watch_connect_exports
});
...
import_protobuf.proto3.util.setEnumType(RedeemerPurpose, "utxorpc.v1alpha.cardano.RedeemerPurpose", [
...
import_protobuf.proto3.util.setEnumType(MirSource, "utxorpc.v1alpha.cardano.MirSource", [
  { no: 0, name: "MIR_SOURCE_UNSPECIFIED" },
  { no: 1, name: "MIR_SOURCE_RESERVES" },
  { no: 2, name: "MIR_SOURCE_TREASURY" }
]);
var _Redeemer = class _Redeemer extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Redeemer, a, b);
  }
};
_Redeemer.runtime = import_protobuf.proto3;
_Redeemer.typeName = "utxorpc.v1alpha.cardano.Redeemer";
_Redeemer.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "purpose", kind: "enum", T: import_protobuf.proto3.getEnumType(RedeemerPurpose) },
...
var _TxInput = class _TxInput extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TxInput, a, b);
  }
};
_TxInput.runtime = import_protobuf.proto3;
_TxInput.typeName = "utxorpc.v1alpha.cardano.TxInput";
_TxInput.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "tx_hash",
    kind: "scalar",
...
var _TxOutput = class _TxOutput extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.coin = import_protobuf.protoInt64.zero;
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TxOutput, a, b);
  }
};
_TxOutput.runtime = import_protobuf.proto3;
_TxOutput.typeName = "utxorpc.v1alpha.cardano.TxOutput";
_TxOutput.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "address",
    kind: "scalar",
...
var _Datum = class _Datum extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Datum, a, b);
  }
};
_Datum.runtime = import_protobuf.proto3;
_Datum.typeName = "utxorpc.v1alpha.cardano.Datum";
_Datum.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "hash",
    kind: "scalar",
...
var Datum = _Datum;
var _Asset = class _Asset extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.outputCoin = import_protobuf.protoInt64.zero;
    /**
     * Quantity of the custom asset in case of a mint.
     *
     * @generated from field: int64 mint_coin = 3;
     */
    this.mintCoin = import_protobuf.protoInt64.zero;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Asset, a, b);
  }
};
_Asset.runtime = import_protobuf.proto3;
_Asset.typeName = "utxorpc.v1alpha.cardano.Asset";
_Asset.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "name",
    kind: "scalar",
...
var Asset = _Asset;
var _Multiasset = class _Multiasset extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Multiasset, a, b);
  }
};
_Multiasset.runtime = import_protobuf.proto3;
_Multiasset.typeName = "utxorpc.v1alpha.cardano.Multiasset";
_Multiasset.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "policy_id",
    kind: "scalar",
...
var _TxValidity = class _TxValidity extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.start = import_protobuf.protoInt64.zero;
    /**
     * End of the validity interval (TTL: Time to Live).
     *
     * @generated from field: uint64 ttl = 2;
     */
    this.ttl = import_protobuf.protoInt64.zero;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TxValidity, a, b);
  }
};
_TxValidity.runtime = import_protobuf.proto3;
_TxValidity.typeName = "utxorpc.v1alpha.cardano.TxValidity";
_TxValidity.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "start",
    kind: "scalar",
...
var _Collateral = class _Collateral extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.totalCollateral = import_protobuf.protoInt64.zero;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Collateral, a, b);
  }
};
_Collateral.runtime = import_protobuf.proto3;
_Collateral.typeName = "utxorpc.v1alpha.cardano.Collateral";
_Collateral.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _Withdrawal = class _Withdrawal extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Withdrawal, a, b);
  }
};
_Withdrawal.runtime = import_protobuf.proto3;
_Withdrawal.typeName = "utxorpc.v1alpha.cardano.Withdrawal";
_Withdrawal.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "reward_account",
    kind: "scalar",
...
var _WitnessSet = class _WitnessSet extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_WitnessSet, a, b);
  }
};
_WitnessSet.runtime = import_protobuf.proto3;
_WitnessSet.typeName = "utxorpc.v1alpha.cardano.WitnessSet";
_WitnessSet.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _AuxData = class _AuxData extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_AuxData, a, b);
  }
};
_AuxData.runtime = import_protobuf.proto3;
_AuxData.typeName = "utxorpc.v1alpha.cardano.AuxData";
_AuxData.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _Tx = class _Tx extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.fee = import_protobuf.protoInt64.zero;
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Tx, a, b);
  }
};
_Tx.runtime = import_protobuf.proto3;
_Tx.typeName = "utxorpc.v1alpha.cardano.Tx";
_Tx.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var Tx = _Tx;
var _GovernanceActionProposal = class _GovernanceActionProposal extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.deposit = import_protobuf.protoInt64.zero;
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_GovernanceActionProposal, a, b);
  }
};
_GovernanceActionProposal.runtime = import_protobuf.proto3;
_GovernanceActionProposal.typeName = "utxorpc.v1alpha.cardano.GovernanceActionProposal";
_GovernanceActionProposal.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "deposit",
    kind: "scalar",
...
var _GovernanceAction = class _GovernanceAction extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from oneof utxorpc.v1alpha.cardano.GovernanceAction.governance_action
     */
    this.governanceAction = { case: void 0 };
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_GovernanceAction, a, b);
  }
};
_GovernanceAction.runtime = import_protobuf.proto3;
_GovernanceAction.typeName = "utxorpc.v1alpha.cardano.GovernanceAction";
_GovernanceAction.fields = import_protobuf.proto3.util.newFieldList(() => [
  ...
  { no: 7, name: "info_action", kind: "scalar", T: 13, oneof: "governance_action" }
]);
var GovernanceAction = _GovernanceAction;
var _GovernanceActionId = class _GovernanceActionId extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_GovernanceActionId, a, b);
  }
};
_GovernanceActionId.runtime = import_protobuf.proto3;
_GovernanceActionId.typeName = "utxorpc.v1alpha.cardano.GovernanceActionId";
_GovernanceActionId.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "transaction_id",
    kind: "scalar",
...
var _ParameterChangeAction = class _ParameterChangeAction extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_ParameterChangeAction, a, b);
  }
};
_ParameterChangeAction.runtime = import_protobuf.proto3;
_ParameterChangeAction.typeName = "utxorpc.v1alpha.cardano.ParameterChangeAction";
_ParameterChangeAction.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _HardForkInitiationAction = class _HardForkInitiationAction extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_HardForkInitiationAction, a, b);
  }
};
_HardForkInitiationAction.runtime = import_protobuf.proto3;
_HardForkInitiationAction.typeName = "utxorpc.v1alpha.cardano.HardForkInitiationAction";
_HardForkInitiationAction.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "gov_action_id", kind: "message", T: GovernanceActionId },
  { no: 2, name: "protocol_version", kind: "message", T: ProtocolVersion }
]);
var HardForkInitiationAction = _HardForkInitiationAction;
var _TreasuryWithdrawalsAction = class _TreasuryWithdrawalsAction extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TreasuryWithdrawalsAction, a, b);
  }
};
_TreasuryWithdrawalsAction.runtime = import_protobuf.proto3;
_TreasuryWithdrawalsAction.typeName = "utxorpc.v1alpha.cardano.TreasuryWithdrawalsAction";
_TreasuryWithdrawalsAction.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _WithdrawalAmount = class _WithdrawalAmount extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: bytes reward_account = 1;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_WithdrawalAmount, a, b);
  }
};
_WithdrawalAmount.runtime = import_protobuf.proto3;
_WithdrawalAmount.typeName = "utxorpc.v1alpha.cardano.WithdrawalAmount";
_WithdrawalAmount.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "reward_account",
    kind: "scalar",
...
var _NoConfidenceAction = class _NoConfidenceAction extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_NoConfidenceAction, a, b);
  }
};
_NoConfidenceAction.runtime = import_protobuf.proto3;
_NoConfidenceAction.typeName = "utxorpc.v1alpha.cardano.NoConfidenceAction";
_NoConfidenceAction.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "gov_action_id", kind: "message", T: GovernanceActionId }
]);
var NoConfidenceAction = _NoConfidenceAction;
var _UpdateCommitteeAction = class _UpdateCommitteeAction extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_UpdateCommitteeAction, a, b);
  }
};
_UpdateCommitteeAction.runtime = import_protobuf.proto3;
_UpdateCommitteeAction.typeName = "utxorpc.v1alpha.cardano.UpdateCommitteeAction";
_UpdateCommitteeAction.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "gov_action_id", kind: "message", T: GovernanceActionId },
...
var _NewConstitutionAction = class _NewConstitutionAction extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_NewConstitutionAction, a, b);
  }
};
_NewConstitutionAction.runtime = import_protobuf.proto3;
_NewConstitutionAction.typeName = "utxorpc.v1alpha.cardano.NewConstitutionAction";
_NewConstitutionAction.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "gov_action_id", kind: "message", T: GovernanceActionId },
  { no: 2, name: "constitution", kind: "message", T: Constitution }
]);
var NewConstitutionAction = _NewConstitutionAction;
var _Constitution = class _Constitution extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Constitution, a, b);
  }
};
_Constitution.runtime = import_protobuf.proto3;
_Constitution.typeName = "utxorpc.v1alpha.cardano.Constitution";
_Constitution.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _NewCommitteeCredentials = class _NewCommitteeCredentials extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_NewCommitteeCredentials, a, b);
  }
};
_NewCommitteeCredentials.runtime = import_protobuf.proto3;
_NewCommitteeCredentials.typeName = "utxorpc.v1alpha.cardano.NewCommitteeCredentials";
_NewCommitteeCredentials.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _BlockHeader = class _BlockHeader extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * Slot number.
     ...
     */
    this.slot = import_protobuf.protoInt64.zero;
    /**
     * Block hash.
     *
     * @generated from field: bytes hash = 2;
     ...
     */
    this.height = import_protobuf.protoInt64.zero;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_BlockHeader, a, b);
  }
};
_BlockHeader.runtime = import_protobuf.proto3;
_BlockHeader.typeName = "utxorpc.v1alpha.cardano.BlockHeader";
_BlockHeader.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "slot",
    kind: "scalar",
...
var _BlockBody = class _BlockBody extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_BlockBody, a, b);
  }
};
_BlockBody.runtime = import_protobuf.proto3;
_BlockBody.typeName = "utxorpc.v1alpha.cardano.BlockBody";
_BlockBody.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "tx", kind: "message", T: Tx, repeated: true }
]);
var BlockBody = _BlockBody;
var _Block = class _Block extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Block, a, b);
  }
};
_Block.runtime = import_protobuf.proto3;
_Block.typeName = "utxorpc.v1alpha.cardano.Block";
_Block.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "header", kind: "message", T: BlockHeader },
  { no: 2, name: "body", kind: "message", T: BlockBody }
]);
var Block = _Block;
var _VKeyWitness = class _VKeyWitness extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * Verification key.
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_VKeyWitness, a, b);
  }
};
_VKeyWitness.runtime = import_protobuf.proto3;
_VKeyWitness.typeName = "utxorpc.v1alpha.cardano.VKeyWitness";
_VKeyWitness.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "vkey",
    kind: "scalar",
...
var _NativeScript = class _NativeScript extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_NativeScript, a, b);
  }
};
_NativeScript.runtime = import_protobuf.proto3;
_NativeScript.typeName = "utxorpc.v1alpha.cardano.NativeScript";
_NativeScript.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _NativeScriptList = class _NativeScriptList extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_NativeScriptList, a, b);
  }
};
_NativeScriptList.runtime = import_protobuf.proto3;
_NativeScriptList.typeName = "utxorpc.v1alpha.cardano.NativeScriptList";
_NativeScriptList.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "items", kind: "message", T: NativeScript, repeated: true }
]);
var NativeScriptList = _NativeScriptList;
var _ScriptNOfK = class _ScriptNOfK extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_ScriptNOfK, a, b);
  }
};
_ScriptNOfK.runtime = import_protobuf.proto3;
_ScriptNOfK.typeName = "utxorpc.v1alpha.cardano.ScriptNOfK";
_ScriptNOfK.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "k",
    kind: "scalar",
...
var _Constr = class _Constr extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.anyConstructor = import_protobuf.protoInt64.zero;
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Constr, a, b);
  }
};
_Constr.runtime = import_protobuf.proto3;
_Constr.typeName = "utxorpc.v1alpha.cardano.Constr";
_Constr.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "tag",
    kind: "scalar",
...
var Constr = _Constr;
var _BigInt = class _BigInt extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_BigInt, a, b);
  }
};
_BigInt.runtime = import_protobuf.proto3;
_BigInt.typeName = "utxorpc.v1alpha.cardano.BigInt";
_BigInt.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var BigInt = _BigInt;
var _PlutusDataPair = class _PlutusDataPair extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_PlutusDataPair, a, b);
  }
};
_PlutusDataPair.runtime = import_protobuf.proto3;
_PlutusDataPair.typeName = "utxorpc.v1alpha.cardano.PlutusDataPair";
_PlutusDataPair.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "key", kind: "message", T: PlutusData },
  { no: 2, name: "value", kind: "message", T: PlutusData }
]);
var PlutusDataPair = _PlutusDataPair;
var _PlutusData = class _PlutusData extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_PlutusData, a, b);
  }
};
_PlutusData.runtime = import_protobuf.proto3;
_PlutusData.typeName = "utxorpc.v1alpha.cardano.PlutusData";
_PlutusData.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _PlutusDataMap = class _PlutusDataMap extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_PlutusDataMap, a, b);
  }
};
_PlutusDataMap.runtime = import_protobuf.proto3;
_PlutusDataMap.typeName = "utxorpc.v1alpha.cardano.PlutusDataMap";
_PlutusDataMap.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "pairs", kind: "message", T: PlutusDataPair, repeated: true }
]);
var PlutusDataMap = _PlutusDataMap;
var _PlutusDataArray = class _PlutusDataArray extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_PlutusDataArray, a, b);
  }
};
_PlutusDataArray.runtime = import_protobuf.proto3;
_PlutusDataArray.typeName = "utxorpc.v1alpha.cardano.PlutusDataArray";
_PlutusDataArray.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "items", kind: "message", T: PlutusData, repeated: true }
]);
var PlutusDataArray = _PlutusDataArray;
var _Script = class _Script extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Script, a, b);
  }
};
_Script.runtime = import_protobuf.proto3;
_Script.typeName = "utxorpc.v1alpha.cardano.Script";
_Script.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var Script = _Script;
var _Metadatum = class _Metadatum extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Metadatum, a, b);
  }
};
_Metadatum.runtime = import_protobuf.proto3;
_Metadatum.typeName = "utxorpc.v1alpha.cardano.Metadatum";
_Metadatum.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _MetadatumArray = class _MetadatumArray extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_MetadatumArray, a, b);
  }
};
_MetadatumArray.runtime = import_protobuf.proto3;
_MetadatumArray.typeName = "utxorpc.v1alpha.cardano.MetadatumArray";
_MetadatumArray.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "items", kind: "message", T: Metadatum, repeated: true }
]);
var MetadatumArray = _MetadatumArray;
var _MetadatumMap = class _MetadatumMap extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_MetadatumMap, a, b);
  }
};
_MetadatumMap.runtime = import_protobuf.proto3;
_MetadatumMap.typeName = "utxorpc.v1alpha.cardano.MetadatumMap";
_MetadatumMap.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "pairs", kind: "message", T: MetadatumPair, repeated: true }
]);
var MetadatumMap = _MetadatumMap;
var _MetadatumPair = class _MetadatumPair extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_MetadatumPair, a, b);
  }
};
_MetadatumPair.runtime = import_protobuf.proto3;
_MetadatumPair.typeName = "utxorpc.v1alpha.cardano.MetadatumPair";
_MetadatumPair.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "key", kind: "message", T: Metadatum },
  { no: 2, name: "value", kind: "message", T: Metadatum }
]);
var MetadatumPair = _MetadatumPair;
var _Metadata = class _Metadata extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: uint64 label = 1;
     */
    this.label = import_protobuf.protoInt64.zero;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Metadata, a, b);
  }
};
_Metadata.runtime = import_protobuf.proto3;
_Metadata.typeName = "utxorpc.v1alpha.cardano.Metadata";
_Metadata.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "label",
    kind: "scalar",
...
var _StakeCredential = class _StakeCredential extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_StakeCredential, a, b);
  }
};
_StakeCredential.runtime = import_protobuf.proto3;
_StakeCredential.typeName = "utxorpc.v1alpha.cardano.StakeCredential";
_StakeCredential.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _RationalNumber = class _RationalNumber extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_RationalNumber, a, b);
  }
};
_RationalNumber.runtime = import_protobuf.proto3;
_RationalNumber.typeName = "utxorpc.v1alpha.cardano.RationalNumber";
_RationalNumber.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "numerator",
    kind: "scalar",
...
var _Relay = class _Relay extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Relay, a, b);
  }
};
_Relay.runtime = import_protobuf.proto3;
_Relay.typeName = "utxorpc.v1alpha.cardano.Relay";
_Relay.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "ip_v4",
    kind: "scalar",
...
var Relay = _Relay;
var _PoolMetadata = class _PoolMetadata extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_PoolMetadata, a, b);
  }
};
_PoolMetadata.runtime = import_protobuf.proto3;
_PoolMetadata.typeName = "utxorpc.v1alpha.cardano.PoolMetadata";
_PoolMetadata.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "url",
    kind: "scalar",
...
var _Certificate = class _Certificate extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Certificate, a, b);
  }
};
_Certificate.runtime = import_protobuf.proto3;
_Certificate.typeName = "utxorpc.v1alpha.cardano.Certificate";
_Certificate.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _StakeDelegationCert = class _StakeDelegationCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * Pool key hash.
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_StakeDelegationCert, a, b);
  }
};
_StakeDelegationCert.runtime = import_protobuf.proto3;
_StakeDelegationCert.typeName = "utxorpc.v1alpha.cardano.StakeDelegationCert";
_StakeDelegationCert.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _PoolRegistrationCert = class _PoolRegistrationCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * Operator key hash.
     ...
     */
    this.pledge = import_protobuf.protoInt64.zero;
    /**
     * Pool cost.
     *
     * @generated from field: uint64 cost = 4;
     */
    this.cost = import_protobuf.protoInt64.zero;
    /**
     * Reward account.
     *
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_PoolRegistrationCert, a, b);
  }
};
_PoolRegistrationCert.runtime = import_protobuf.proto3;
_PoolRegistrationCert.typeName = "utxorpc.v1alpha.cardano.PoolRegistrationCert";
_PoolRegistrationCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "operator",
    kind: "scalar",
...
var _PoolRetirementCert = class _PoolRetirementCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * Pool key hash.
     ...
     */
    this.epoch = import_protobuf.protoInt64.zero;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_PoolRetirementCert, a, b);
  }
};
_PoolRetirementCert.runtime = import_protobuf.proto3;
_PoolRetirementCert.typeName = "utxorpc.v1alpha.cardano.PoolRetirementCert";
_PoolRetirementCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "pool_keyhash",
    kind: "scalar",
...
var _GenesisKeyDelegationCert = class _GenesisKeyDelegationCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * Genesis hash.
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_GenesisKeyDelegationCert, a, b);
  }
};
_GenesisKeyDelegationCert.runtime = import_protobuf.proto3;
_GenesisKeyDelegationCert.typeName = "utxorpc.v1alpha.cardano.GenesisKeyDelegationCert";
_GenesisKeyDelegationCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "genesis_hash",
    kind: "scalar",
...
var _MirTarget = class _MirTarget extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: int64 delta_coin = 2;
     */
    this.deltaCoin = import_protobuf.protoInt64.zero;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_MirTarget, a, b);
  }
};
_MirTarget.runtime = import_protobuf.proto3;
_MirTarget.typeName = "utxorpc.v1alpha.cardano.MirTarget";
_MirTarget.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "stake_credential", kind: "message", T: StakeCredential },
  {
    no: 2,
    name: "delta_coin",
...
var _MirCert = class _MirCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.otherPot = import_protobuf.protoInt64.zero;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_MirCert, a, b);
  }
};
_MirCert.runtime = import_protobuf.proto3;
_MirCert.typeName = "utxorpc.v1alpha.cardano.MirCert";
_MirCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "from", kind: "enum", T: import_protobuf.proto3.getEnumType(MirSource) },
...
var _RegCert = class _RegCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: uint64 coin = 2;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_RegCert, a, b);
  }
};
_RegCert.runtime = import_protobuf.proto3;
_RegCert.typeName = "utxorpc.v1alpha.cardano.RegCert";
_RegCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "stake_credential", kind: "message", T: StakeCredential },
  {
    no: 2,
    name: "coin",
...
var _UnRegCert = class _UnRegCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: uint64 coin = 2;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_UnRegCert, a, b);
  }
};
_UnRegCert.runtime = import_protobuf.proto3;
_UnRegCert.typeName = "utxorpc.v1alpha.cardano.UnRegCert";
_UnRegCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "stake_credential", kind: "message", T: StakeCredential },
  {
    no: 2,
    name: "coin",
...
var _DRep = class _DRep extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_DRep, a, b);
  }
};
_DRep.runtime = import_protobuf.proto3;
_DRep.typeName = "utxorpc.v1alpha.cardano.DRep";
_DRep.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var DRep = _DRep;
var _VoteDelegCert = class _VoteDelegCert extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_VoteDelegCert, a, b);
  }
};
_VoteDelegCert.runtime = import_protobuf.proto3;
_VoteDelegCert.typeName = "utxorpc.v1alpha.cardano.VoteDelegCert";
_VoteDelegCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "stake_credential", kind: "message", T: StakeCredential },
  { no: 2, name: "drep", kind: "message", T: DRep }
]);
var VoteDelegCert = _VoteDelegCert;
var _StakeVoteDelegCert = class _StakeVoteDelegCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: bytes pool_keyhash = 2;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_StakeVoteDelegCert, a, b);
  }
};
_StakeVoteDelegCert.runtime = import_protobuf.proto3;
_StakeVoteDelegCert.typeName = "utxorpc.v1alpha.cardano.StakeVoteDelegCert";
_StakeVoteDelegCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "stake_credential", kind: "message", T: StakeCredential },
  {
    no: 2,
    name: "pool_keyhash",
...
var _StakeRegDelegCert = class _StakeRegDelegCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: bytes pool_keyhash = 2;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_StakeRegDelegCert, a, b);
  }
};
_StakeRegDelegCert.runtime = import_protobuf.proto3;
_StakeRegDelegCert.typeName = "utxorpc.v1alpha.cardano.StakeRegDelegCert";
_StakeRegDelegCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "stake_credential", kind: "message", T: StakeCredential },
  {
    no: 2,
    name: "pool_keyhash",
...
var _VoteRegDelegCert = class _VoteRegDelegCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: uint64 coin = 3;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_VoteRegDelegCert, a, b);
  }
};
_VoteRegDelegCert.runtime = import_protobuf.proto3;
_VoteRegDelegCert.typeName = "utxorpc.v1alpha.cardano.VoteRegDelegCert";
_VoteRegDelegCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "stake_credential", kind: "message", T: StakeCredential },
  { no: 2, name: "drep", kind: "message", T: DRep },
  {
    no: 3,
...
var _StakeVoteRegDelegCert = class _StakeVoteRegDelegCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: bytes pool_keyhash = 2;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_StakeVoteRegDelegCert, a, b);
  }
};
_StakeVoteRegDelegCert.runtime = import_protobuf.proto3;
_StakeVoteRegDelegCert.typeName = "utxorpc.v1alpha.cardano.StakeVoteRegDelegCert";
_StakeVoteRegDelegCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "stake_credential", kind: "message", T: StakeCredential },
  {
    no: 2,
    name: "pool_keyhash",
...
var _AuthCommitteeHotCert = class _AuthCommitteeHotCert extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_AuthCommitteeHotCert, a, b);
  }
};
_AuthCommitteeHotCert.runtime = import_protobuf.proto3;
_AuthCommitteeHotCert.typeName = "utxorpc.v1alpha.cardano.AuthCommitteeHotCert";
_AuthCommitteeHotCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "committee_cold_credential", kind: "message", T: StakeCredential },
  { no: 2, name: "committee_hot_credential", kind: "message", T: StakeCredential }
]);
var AuthCommitteeHotCert = _AuthCommitteeHotCert;
var _Anchor = class _Anchor extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string url = 1;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Anchor, a, b);
  }
};
_Anchor.runtime = import_protobuf.proto3;
_Anchor.typeName = "utxorpc.v1alpha.cardano.Anchor";
_Anchor.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "url",
    kind: "scalar",
...
var Anchor = _Anchor;
var _ResignCommitteeColdCert = class _ResignCommitteeColdCert extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_ResignCommitteeColdCert, a, b);
  }
};
_ResignCommitteeColdCert.runtime = import_protobuf.proto3;
_ResignCommitteeColdCert.typeName = "utxorpc.v1alpha.cardano.ResignCommitteeColdCert";
_ResignCommitteeColdCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "committee_cold_credential", kind: "message", T: StakeCredential },
  { no: 2, name: "anchor", kind: "message", T: Anchor }
]);
var ResignCommitteeColdCert = _ResignCommitteeColdCert;
var _RegDRepCert = class _RegDRepCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: uint64 coin = 2;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_RegDRepCert, a, b);
  }
};
_RegDRepCert.runtime = import_protobuf.proto3;
_RegDRepCert.typeName = "utxorpc.v1alpha.cardano.RegDRepCert";
_RegDRepCert.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _UnRegDRepCert = class _UnRegDRepCert extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: uint64 coin = 2;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_UnRegDRepCert, a, b);
  }
};
_UnRegDRepCert.runtime = import_protobuf.proto3;
_UnRegDRepCert.typeName = "utxorpc.v1alpha.cardano.UnRegDRepCert";
_UnRegDRepCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "drep_credential", kind: "message", T: StakeCredential },
  {
    no: 2,
    name: "coin",
...
var _UpdateDRepCert = class _UpdateDRepCert extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_UpdateDRepCert, a, b);
  }
};
_UpdateDRepCert.runtime = import_protobuf.proto3;
_UpdateDRepCert.typeName = "utxorpc.v1alpha.cardano.UpdateDRepCert";
_UpdateDRepCert.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "drep_credential", kind: "message", T: StakeCredential },
  { no: 2, name: "anchor", kind: "message", T: Anchor }
]);
var UpdateDRepCert = _UpdateDRepCert;
var _AddressPattern = class _AddressPattern extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_AddressPattern, a, b);
  }
};
_AddressPattern.runtime = import_protobuf.proto3;
_AddressPattern.typeName = "utxorpc.v1alpha.cardano.AddressPattern";
_AddressPattern.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "exact_address",
    kind: "scalar",
...
var _AssetPattern = class _AssetPattern extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_AssetPattern, a, b);
  }
};
_AssetPattern.runtime = import_protobuf.proto3;
_AssetPattern.typeName = "utxorpc.v1alpha.cardano.AssetPattern";
_AssetPattern.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "policy_id",
    kind: "scalar",
...
var _TxOutputPattern = class _TxOutputPattern extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TxOutputPattern, a, b);
  }
};
_TxOutputPattern.runtime = import_protobuf.proto3;
_TxOutputPattern.typeName = "utxorpc.v1alpha.cardano.TxOutputPattern";
_TxOutputPattern.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _TxPattern = class _TxPattern extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TxPattern, a, b);
  }
};
_TxPattern.runtime = import_protobuf.proto3;
_TxPattern.typeName = "utxorpc.v1alpha.cardano.TxPattern";
_TxPattern.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _ExUnits = class _ExUnits extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: uint64 steps = 1;
     */
    this.steps = import_protobuf.protoInt64.zero;
    /**
     * @generated from field: uint64 memory = 2;
     */
    this.memory = import_protobuf.protoInt64.zero;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_ExUnits, a, b);
  }
};
_ExUnits.runtime = import_protobuf.proto3;
_ExUnits.typeName = "utxorpc.v1alpha.cardano.ExUnits";
_ExUnits.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "steps",
    kind: "scalar",
...
var _ExPrices = class _ExPrices extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_ExPrices, a, b);
  }
};
_ExPrices.runtime = import_protobuf.proto3;
_ExPrices.typeName = "utxorpc.v1alpha.cardano.ExPrices";
_ExPrices.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "steps", kind: "message", T: RationalNumber },
  { no: 2, name: "memory", kind: "message", T: RationalNumber }
]);
var ExPrices = _ExPrices;
var _ProtocolVersion = class _ProtocolVersion extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_ProtocolVersion, a, b);
  }
};
_ProtocolVersion.runtime = import_protobuf.proto3;
_ProtocolVersion.typeName = "utxorpc.v1alpha.cardano.ProtocolVersion";
_ProtocolVersion.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "major",
    kind: "scalar",
...
var _CostModel = class _CostModel extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_CostModel, a, b);
  }
};
_CostModel.runtime = import_protobuf.proto3;
_CostModel.typeName = "utxorpc.v1alpha.cardano.CostModel";
_CostModel.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "values", kind: "scalar", T: 3, repeated: true }
]);
var CostModel = _CostModel;
var _CostModels = class _CostModels extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_CostModels, a, b);
  }
};
_CostModels.runtime = import_protobuf.proto3;
_CostModels.typeName = "utxorpc.v1alpha.cardano.CostModels";
_CostModels.fields = import_protobuf.proto3.util.newFieldList(() => [
...
var _VotingThresholds = class _VotingThresholds extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_VotingThresholds, a, b);
  }
};
_VotingThresholds.runtime = import_protobuf.proto3;
_VotingThresholds.typeName = "utxorpc.v1alpha.cardano.VotingThresholds";
_VotingThresholds.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "thresholds", kind: "message", T: RationalNumber, repeated: true }
]);
var VotingThresholds = _VotingThresholds;
var _PParams = class _PParams extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_PParams, a, b);
  }
};
_PParams.runtime = import_protobuf.proto3;
_PParams.typeName = "utxorpc.v1alpha.cardano.PParams";
_PParams.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
...
var _EvalError = class _EvalError extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_EvalError, a, b);
  }
};
_EvalError.runtime = import_protobuf.proto3;
_EvalError.typeName = "utxorpc.v1alpha.cardano.EvalError";
_EvalError.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "msg",
    kind: "scalar",
...
var _EvalTrace = class _EvalTrace extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string msg = 1;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_EvalTrace, a, b);
  }
};
_EvalTrace.runtime = import_protobuf.proto3;
_EvalTrace.typeName = "utxorpc.v1alpha.cardano.EvalTrace";
_EvalTrace.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "msg",
    kind: "scalar",
...
var _TxEval = class _TxEval extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TxEval, a, b);
  }
};
_TxEval.runtime = import_protobuf.proto3;
_TxEval.typeName = "utxorpc.v1alpha.cardano.TxEval";
_TxEval.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "fee",
    kind: "scalar",
...
var _ChainPoint = class _ChainPoint extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
     * Slot number.
     ...
     * @generated from field: uint64 slot = 1;
     */
    this.slot = import_protobuf2.protoInt64.zero;
    /**
     * Block hash.
     *
     * @generated from field: bytes hash = 2;
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_ChainPoint, a, b);
  }
};
_ChainPoint.runtime = import_protobuf2.proto3;
_ChainPoint.typeName = "utxorpc.v1alpha.query.ChainPoint";
_ChainPoint.fields = import_protobuf2.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "slot",
    kind: "scalar",
...
var _TxoRef = class _TxoRef extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
     * Tx hash.
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_TxoRef, a, b);
  }
};
_TxoRef.runtime = import_protobuf2.proto3;
_TxoRef.typeName = "utxorpc.v1alpha.query.TxoRef";
_TxoRef.fields = import_protobuf2.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "hash",
    kind: "scalar",
...
var TxoRef = _TxoRef;
var _ReadParamsRequest = class _ReadParamsRequest extends import_protobuf2.Message {
  constructor(data) {
    super();
    import_protobuf2.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_ReadParamsRequest, a, b);
  }
};
_ReadParamsRequest.runtime = import_protobuf2.proto3;
_ReadParamsRequest.typeName = "utxorpc.v1alpha.query.ReadParamsRequest";
_ReadParamsRequest.fields = import_protobuf2.proto3.util.newFieldList(() => [
  { no: 1, name: "field_mask", kind: "message", T: import_protobuf2.FieldMask }
]);
var ReadParamsRequest = _ReadParamsRequest;
var _AnyChainParams = class _AnyChainParams extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_AnyChainParams, a, b);
  }
};
_AnyChainParams.runtime = import_protobuf2.proto3;
_AnyChainParams.typeName = "utxorpc.v1alpha.query.AnyChainParams";
_AnyChainParams.fields = import_protobuf2.proto3.util.newFieldList(() => [
  { no: 1, name: "cardano", kind: "message", T: PParams, oneof: "params" }
]);
var AnyChainParams = _AnyChainParams;
var _ReadParamsResponse = class _ReadParamsResponse extends import_protobuf2.Message {
  constructor(data) {
    super();
    import_protobuf2.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_ReadParamsResponse, a, b);
  }
};
_ReadParamsResponse.runtime = import_protobuf2.proto3;
_ReadParamsResponse.typeName = "utxorpc.v1alpha.query.ReadParamsResponse";
_ReadParamsResponse.fields = import_protobuf2.proto3.util.newFieldList(() => [
...
var _AnyUtxoPattern = class _AnyUtxoPattern extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_AnyUtxoPattern, a, b);
  }
};
_AnyUtxoPattern.runtime = import_protobuf2.proto3;
_AnyUtxoPattern.typeName = "utxorpc.v1alpha.query.AnyUtxoPattern";
_AnyUtxoPattern.fields = import_protobuf2.proto3.util.newFieldList(() => [
  { no: 1, name: "cardano", kind: "message", T: TxOutputPattern, oneof: "utxo_pattern" }
]);
var AnyUtxoPattern = _AnyUtxoPattern;
var _UtxoPredicate = class _UtxoPredicate extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_UtxoPredicate, a, b);
  }
};
_UtxoPredicate.runtime = import_protobuf2.proto3;
_UtxoPredicate.typeName = "utxorpc.v1alpha.query.UtxoPredicate";
_UtxoPredicate.fields = import_protobuf2.proto3.util.newFieldList(() => [
...
var _AnyUtxoData = class _AnyUtxoData extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_AnyUtxoData, a, b);
  }
};
_AnyUtxoData.runtime = import_protobuf2.proto3;
_AnyUtxoData.typeName = "utxorpc.v1alpha.query.AnyUtxoData";
_AnyUtxoData.fields = import_protobuf2.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "native_bytes",
    kind: "scalar",
...
var _ReadUtxosRequest = class _ReadUtxosRequest extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
     * List of keys UTxOs.
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_ReadUtxosRequest, a, b);
  }
};
_ReadUtxosRequest.runtime = import_protobuf2.proto3;
_ReadUtxosRequest.typeName = "utxorpc.v1alpha.query.ReadUtxosRequest";
_ReadUtxosRequest.fields = import_protobuf2.proto3.util.newFieldList(() => [
  { no: 1, name: "keys", kind: "message", T: TxoRef, repeated: true },
  { no: 2, name: "field_mask", kind: "message", T: import_protobuf2.FieldMask }
]);
var ReadUtxosRequest = _ReadUtxosRequest;
var _ReadUtxosResponse = class _ReadUtxosResponse extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
     * List of UTxOs.
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_ReadUtxosResponse, a, b);
  }
};
_ReadUtxosResponse.runtime = import_protobuf2.proto3;
_ReadUtxosResponse.typeName = "utxorpc.v1alpha.query.ReadUtxosResponse";
_ReadUtxosResponse.fields = import_protobuf2.proto3.util.newFieldList(() => [
  { no: 1, name: "items", kind: "message", T: AnyUtxoData, repeated: true },
  { no: 2, name: "ledger_tip", kind: "message", T: ChainPoint }
]);
var ReadUtxosResponse = _ReadUtxosResponse;
var _SearchUtxosRequest = class _SearchUtxosRequest extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_SearchUtxosRequest, a, b);
  }
};
_SearchUtxosRequest.runtime = import_protobuf2.proto3;
_SearchUtxosRequest.typeName = "utxorpc.v1alpha.query.SearchUtxosRequest";
_SearchUtxosRequest.fields = import_protobuf2.proto3.util.newFieldList(() => [
...
var _SearchUtxosResponse = class _SearchUtxosResponse extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
     * List of UTxOs.
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_SearchUtxosResponse, a, b);
  }
};
_SearchUtxosResponse.runtime = import_protobuf2.proto3;
_SearchUtxosResponse.typeName = "utxorpc.v1alpha.query.SearchUtxosResponse";
_SearchUtxosResponse.fields = import_protobuf2.proto3.util.newFieldList(() => [
  { no: 1, name: "items", kind: "message", T: AnyUtxoData, repeated: true },
  { no: 2, name: "ledger_tip", kind: "message", T: ChainPoint },
  {
    no: 3,
...
var _ReadDataRequest = class _ReadDataRequest extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_ReadDataRequest, a, b);
  }
};
_ReadDataRequest.runtime = import_protobuf2.proto3;
_ReadDataRequest.typeName = "utxorpc.v1alpha.query.ReadDataRequest";
_ReadDataRequest.fields = import_protobuf2.proto3.util.newFieldList(() => [
  { no: 1, name: "keys", kind: "scalar", T: 12, repeated: true },
  { no: 2, name: "field_mask", kind: "message", T: import_protobuf2.FieldMask }
]);
var ReadDataRequest = _ReadDataRequest;
var _AnyChainDatum = class _AnyChainDatum extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
     * Original bytes as defined by the chain
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_AnyChainDatum, a, b);
  }
};
_AnyChainDatum.runtime = import_protobuf2.proto3;
_AnyChainDatum.typeName = "utxorpc.v1alpha.query.AnyChainDatum";
_AnyChainDatum.fields = import_protobuf2.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "native_bytes",
    kind: "scalar",
...
var _ReadDataResponse = class _ReadDataResponse extends import_protobuf2.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf2.proto3.util.equals(_ReadDataResponse, a, b);
  }
};
_ReadDataResponse.runtime = import_protobuf2.proto3;
_ReadDataResponse.typeName = "utxorpc.v1alpha.query.ReadDataResponse";
_ReadDataResponse.fields = import_protobuf2.proto3.util.newFieldList(() => [
...
var QueryService = {
  ...
  methods: {
    ...
    readParams: {
      ...
      kind: import_protobuf3.MethodKind.Unary
    },
    /**
...
import_protobuf4.proto3.util.setEnumType(Stage, "utxorpc.v1alpha.submit.Stage", [
...
var _AnyChainTx = class _AnyChainTx extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_AnyChainTx, a, b);
  }
};
_AnyChainTx.runtime = import_protobuf4.proto3;
_AnyChainTx.typeName = "utxorpc.v1alpha.submit.AnyChainTx";
_AnyChainTx.fields = import_protobuf4.proto3.util.newFieldList(() => [
  { no: 1, name: "raw", kind: "scalar", T: 12, oneof: "type" }
]);
var AnyChainTx = _AnyChainTx;
var _EvalTxRequest = class _EvalTxRequest extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_EvalTxRequest, a, b);
  }
};
_EvalTxRequest.runtime = import_protobuf4.proto3;
_EvalTxRequest.typeName = "utxorpc.v1alpha.submit.EvalTxRequest";
_EvalTxRequest.fields = import_protobuf4.proto3.util.newFieldList(() => [
  { no: 1, name: "tx", kind: "message", T: AnyChainTx, repeated: true }
]);
var EvalTxRequest = _EvalTxRequest;
var _AnyChainEval = class _AnyChainEval extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_AnyChainEval, a, b);
  }
};
_AnyChainEval.runtime = import_protobuf4.proto3;
_AnyChainEval.typeName = "utxorpc.v1alpha.submit.AnyChainEval";
_AnyChainEval.fields = import_protobuf4.proto3.util.newFieldList(() => [
  { no: 1, name: "cardano", kind: "message", T: TxEval, oneof: "chain" }
]);
var AnyChainEval = _AnyChainEval;
var _EvalTxResponse = class _EvalTxResponse extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_EvalTxResponse, a, b);
  }
};
_EvalTxResponse.runtime = import_protobuf4.proto3;
_EvalTxResponse.typeName = "utxorpc.v1alpha.submit.EvalTxResponse";
_EvalTxResponse.fields = import_protobuf4.proto3.util.newFieldList(() => [
  { no: 1, name: "report", kind: "message", T: AnyChainEval, repeated: true }
]);
var EvalTxResponse = _EvalTxResponse;
var _SubmitTxRequest = class _SubmitTxRequest extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_SubmitTxRequest, a, b);
  }
};
_SubmitTxRequest.runtime = import_protobuf4.proto3;
_SubmitTxRequest.typeName = "utxorpc.v1alpha.submit.SubmitTxRequest";
_SubmitTxRequest.fields = import_protobuf4.proto3.util.newFieldList(() => [
  { no: 1, name: "tx", kind: "message", T: AnyChainTx, repeated: true }
]);
var SubmitTxRequest = _SubmitTxRequest;
var _SubmitTxResponse = class _SubmitTxResponse extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_SubmitTxResponse, a, b);
  }
};
_SubmitTxResponse.runtime = import_protobuf4.proto3;
_SubmitTxResponse.typeName = "utxorpc.v1alpha.submit.SubmitTxResponse";
_SubmitTxResponse.fields = import_protobuf4.proto3.util.newFieldList(() => [
  { no: 1, name: "ref", kind: "scalar", T: 12, repeated: true }
]);
var SubmitTxResponse = _SubmitTxResponse;
var _TxInMempool = class _TxInMempool extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_TxInMempool, a, b);
  }
};
_TxInMempool.runtime = import_protobuf4.proto3;
_TxInMempool.typeName = "utxorpc.v1alpha.submit.TxInMempool";
_TxInMempool.fields = import_protobuf4.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "ref",
    kind: "scalar",
  ...
  { no: 3, name: "stage", kind: "enum", T: import_protobuf4.proto3.getEnumType(Stage) },
  { no: 4, name: "cardano", kind: "message", T: Tx, oneof: "parsed_state" }
]);
var TxInMempool = _TxInMempool;
var _ReadMempoolRequest = class _ReadMempoolRequest extends import_protobuf4.Message {
  constructor(data) {
    super();
    import_protobuf4.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_ReadMempoolRequest, a, b);
  }
};
_ReadMempoolRequest.runtime = import_protobuf4.proto3;
_ReadMempoolRequest.typeName = "utxorpc.v1alpha.submit.ReadMempoolRequest";
_ReadMempoolRequest.fields = import_protobuf4.proto3.util.newFieldList(() => []);
var ReadMempoolRequest = _ReadMempoolRequest;
var _ReadMempoolResponse = class _ReadMempoolResponse extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_ReadMempoolResponse, a, b);
  }
};
_ReadMempoolResponse.runtime = import_protobuf4.proto3;
_ReadMempoolResponse.typeName = "utxorpc.v1alpha.submit.ReadMempoolResponse";
_ReadMempoolResponse.fields = import_protobuf4.proto3.util.newFieldList(() => [
  { no: 1, name: "items", kind: "message", T: TxInMempool, repeated: true }
]);
var ReadMempoolResponse = _ReadMempoolResponse;
var _WaitForTxRequest = class _WaitForTxRequest extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_WaitForTxRequest, a, b);
  }
};
_WaitForTxRequest.runtime = import_protobuf4.proto3;
_WaitForTxRequest.typeName = "utxorpc.v1alpha.submit.WaitForTxRequest";
_WaitForTxRequest.fields = import_protobuf4.proto3.util.newFieldList(() => [
  { no: 1, name: "ref", kind: "scalar", T: 12, repeated: true }
]);
var WaitForTxRequest = _WaitForTxRequest;
var _WaitForTxResponse = class _WaitForTxResponse extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_WaitForTxResponse, a, b);
  }
};
_WaitForTxResponse.runtime = import_protobuf4.proto3;
_WaitForTxResponse.typeName = "utxorpc.v1alpha.submit.WaitForTxResponse";
_WaitForTxResponse.fields = import_protobuf4.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "ref",
    kind: "scalar",
  ...
  { no: 2, name: "stage", kind: "enum", T: import_protobuf4.proto3.getEnumType(Stage) }
]);
var WaitForTxResponse = _WaitForTxResponse;
var _AnyChainTxPattern = class _AnyChainTxPattern extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_AnyChainTxPattern, a, b);
  }
};
_AnyChainTxPattern.runtime = import_protobuf4.proto3;
_AnyChainTxPattern.typeName = "utxorpc.v1alpha.submit.AnyChainTxPattern";
_AnyChainTxPattern.fields = import_protobuf4.proto3.util.newFieldList(() => [
  { no: 1, name: "cardano", kind: "message", T: TxPattern, oneof: "chain" }
]);
var AnyChainTxPattern = _AnyChainTxPattern;
var _TxPredicate = class _TxPredicate extends import_protobuf4.Message {
  constructor(data) {
    super();
    /**
     * Predicate is true if tx doesn't exhibit pattern.
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_TxPredicate, a, b);
  }
};
_TxPredicate.runtime = import_protobuf4.proto3;
_TxPredicate.typeName = "utxorpc.v1alpha.submit.TxPredicate";
_TxPredicate.fields = import_protobuf4.proto3.util.newFieldList(() => [
...
var _WatchMempoolRequest = class _WatchMempoolRequest extends import_protobuf4.Message {
  constructor(data) {
    super();
    import_protobuf4.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_WatchMempoolRequest, a, b);
  }
};
_WatchMempoolRequest.runtime = import_protobuf4.proto3;
_WatchMempoolRequest.typeName = "utxorpc.v1alpha.submit.WatchMempoolRequest";
_WatchMempoolRequest.fields = import_protobuf4.proto3.util.newFieldList(() => [
  { no: 1, name: "predicate", kind: "message", T: TxPredicate },
  { no: 2, name: "field_mask", kind: "message", T: import_protobuf4.FieldMask }
]);
var WatchMempoolRequest = _WatchMempoolRequest;
var _WatchMempoolResponse = class _WatchMempoolResponse extends import_protobuf4.Message {
  constructor(data) {
    super();
    import_protobuf4.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf4.proto3.util.equals(_WatchMempoolResponse, a, b);
  }
};
_WatchMempoolResponse.runtime = import_protobuf4.proto3;
_WatchMempoolResponse.typeName = "utxorpc.v1alpha.submit.WatchMempoolResponse";
_WatchMempoolResponse.fields = import_protobuf4.proto3.util.newFieldList(() => [
...
var SubmitService = {
  ...
  methods: {
    ...
    evalTx: {
      ...
      I: EvalTxRequest,
      O: EvalTxResponse,
      kind: import_protobuf5.MethodKind.Unary
    },
    /**
    ...
    waitForTx: {
      ...
      I: WaitForTxRequest,
      O: WaitForTxResponse,
      kind: import_protobuf5.MethodKind.ServerStreaming
    },
    /**
...
var _BlockRef = class _BlockRef extends import_protobuf6.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.index = import_protobuf6.protoInt64.zero;
    /**
  ...
  static equals(a, b) {
    return import_protobuf6.proto3.util.equals(_BlockRef, a, b);
  }
};
_BlockRef.runtime = import_protobuf6.proto3;
_BlockRef.typeName = "utxorpc.v1alpha.sync.BlockRef";
_BlockRef.fields = import_protobuf6.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "index",
    kind: "scalar",
...
var _AnyChainBlock = class _AnyChainBlock extends import_protobuf6.Message {
  constructor(data) {
    super();
    /**
     * Original bytes as defined by the chain
  ...
  static equals(a, b) {
    return import_protobuf6.proto3.util.equals(_AnyChainBlock, a, b);
  }
};
_AnyChainBlock.runtime = import_protobuf6.proto3;
_AnyChainBlock.typeName = "utxorpc.v1alpha.sync.AnyChainBlock";
_AnyChainBlock.fields = import_protobuf6.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "native_bytes",
    kind: "scalar",
...
var _FetchBlockRequest = class _FetchBlockRequest extends import_protobuf6.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf6.proto3.util.equals(_FetchBlockRequest, a, b);
  }
};
_FetchBlockRequest.runtime = import_protobuf6.proto3;
_FetchBlockRequest.typeName = "utxorpc.v1alpha.sync.FetchBlockRequest";
_FetchBlockRequest.fields = import_protobuf6.proto3.util.newFieldList(() => [
  { no: 1, name: "ref", kind: "message", T: BlockRef, repeated: true },
  { no: 2, name: "field_mask", kind: "message", T: import_protobuf6.FieldMask }
]);
var FetchBlockRequest = _FetchBlockRequest;
var _FetchBlockResponse = class _FetchBlockResponse extends import_protobuf6.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf6.proto3.util.equals(_FetchBlockResponse, a, b);
  }
};
_FetchBlockResponse.runtime = import_protobuf6.proto3;
_FetchBlockResponse.typeName = "utxorpc.v1alpha.sync.FetchBlockResponse";
_FetchBlockResponse.fields = import_protobuf6.proto3.util.newFieldList(() => [
  { no: 1, name: "block", kind: "message", T: AnyChainBlock, repeated: true }
]);
var FetchBlockResponse = _FetchBlockResponse;
var _DumpHistoryRequest = class _DumpHistoryRequest extends import_protobuf6.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf6.proto3.util.equals(_DumpHistoryRequest, a, b);
  }
};
_DumpHistoryRequest.runtime = import_protobuf6.proto3;
_DumpHistoryRequest.typeName = "utxorpc.v1alpha.sync.DumpHistoryRequest";
_DumpHistoryRequest.fields = import_protobuf6.proto3.util.newFieldList(() => [
  ...
  { no: 4, name: "field_mask", kind: "message", T: import_protobuf6.FieldMask }
]);
var DumpHistoryRequest = _DumpHistoryRequest;
var _DumpHistoryResponse = class _DumpHistoryResponse extends import_protobuf6.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf6.proto3.util.equals(_DumpHistoryResponse, a, b);
  }
};
_DumpHistoryResponse.runtime = import_protobuf6.proto3;
_DumpHistoryResponse.typeName = "utxorpc.v1alpha.sync.DumpHistoryResponse";
_DumpHistoryResponse.fields = import_protobuf6.proto3.util.newFieldList(() => [
  { no: 1, name: "block", kind: "message", T: AnyChainBlock, repeated: true },
  { no: 2, name: "next_token", kind: "message", T: BlockRef }
]);
var DumpHistoryResponse = _DumpHistoryResponse;
var _FollowTipRequest = class _FollowTipRequest extends import_protobuf6.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf6.proto3.util.equals(_FollowTipRequest, a, b);
  }
};
_FollowTipRequest.runtime = import_protobuf6.proto3;
_FollowTipRequest.typeName = "utxorpc.v1alpha.sync.FollowTipRequest";
_FollowTipRequest.fields = import_protobuf6.proto3.util.newFieldList(() => [
  { no: 1, name: "intersect", kind: "message", T: BlockRef, repeated: true },
  { no: 2, name: "field_mask", kind: "message", T: import_protobuf6.FieldMask }
]);
var FollowTipRequest = _FollowTipRequest;
var _FollowTipResponse = class _FollowTipResponse extends import_protobuf6.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf6.proto3.util.equals(_FollowTipResponse, a, b);
  }
};
_FollowTipResponse.runtime = import_protobuf6.proto3;
_FollowTipResponse.typeName = "utxorpc.v1alpha.sync.FollowTipResponse";
_FollowTipResponse.fields = import_protobuf6.proto3.util.newFieldList(() => [
...
var _ReadTipRequest = class _ReadTipRequest extends import_protobuf6.Message {
  constructor(data) {
    super();
    import_protobuf6.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf6.proto3.util.equals(_ReadTipRequest, a, b);
  }
};
_ReadTipRequest.runtime = import_protobuf6.proto3;
_ReadTipRequest.typeName = "utxorpc.v1alpha.sync.ReadTipRequest";
_ReadTipRequest.fields = import_protobuf6.proto3.util.newFieldList(() => []);
var ReadTipRequest = _ReadTipRequest;
var _ReadTipResponse = class _ReadTipResponse extends import_protobuf6.Message {
  constructor(data) {
    super();
    import_protobuf6.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf6.proto3.util.equals(_ReadTipResponse, a, b);
  }
};
_ReadTipResponse.runtime = import_protobuf6.proto3;
_ReadTipResponse.typeName = "utxorpc.v1alpha.sync.ReadTipResponse";
_ReadTipResponse.fields = import_protobuf6.proto3.util.newFieldList(() => [
  { no: 1, name: "tip", kind: "message", T: BlockRef }
]);
...
var SyncService = {
  ...
  methods: {
    ...
    followTip: {
      ...
      I: FollowTipRequest,
      O: FollowTipResponse,
      kind: import_protobuf7.MethodKind.ServerStreaming
    },
    /**
...
var _BlockRef2 = class _BlockRef2 extends import_protobuf8.Message {
  constructor(data) {
    super();
    /**
     * Height or slot number (depending on the blockchain)
     ...
     * @generated from field: uint64 index = 1;
     */
    this.index = import_protobuf8.protoInt64.zero;
    /**
     * Hash of the content of the block
     *
     * @generated from field: bytes hash = 2;
     */
    this.hash = new Uint8Array(0);
    import_protobuf8.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf8.proto3.util.equals(_BlockRef2, a, b);
  }
};
_BlockRef2.runtime = import_protobuf8.proto3;
_BlockRef2.typeName = "utxorpc.v1alpha.watch.BlockRef";
_BlockRef2.fields = import_protobuf8.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "index",
    kind: "scalar",
...
var _AnyChainTxPattern2 = class _AnyChainTxPattern2 extends import_protobuf8.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf8.proto3.util.equals(_AnyChainTxPattern2, a, b);
  }
};
_AnyChainTxPattern2.runtime = import_protobuf8.proto3;
_AnyChainTxPattern2.typeName = "utxorpc.v1alpha.watch.AnyChainTxPattern";
_AnyChainTxPattern2.fields = import_protobuf8.proto3.util.newFieldList(() => [
  { no: 1, name: "cardano", kind: "message", T: TxPattern, oneof: "chain" }
]);
var AnyChainTxPattern2 = _AnyChainTxPattern2;
var _TxPredicate2 = class _TxPredicate2 extends import_protobuf8.Message {
  constructor(data) {
    super();
    /**
     * Predicate is true if tx doesn't exhibit pattern.
  ...
  static equals(a, b) {
    return import_protobuf8.proto3.util.equals(_TxPredicate2, a, b);
  }
};
_TxPredicate2.runtime = import_protobuf8.proto3;
_TxPredicate2.typeName = "utxorpc.v1alpha.watch.TxPredicate";
_TxPredicate2.fields = import_protobuf8.proto3.util.newFieldList(() => [
...
var _WatchTxRequest = class _WatchTxRequest extends import_protobuf8.Message {
  constructor(data) {
    super();
    /**
     * List of block references to find the intersection.
  ...
  static equals(a, b) {
    return import_protobuf8.proto3.util.equals(_WatchTxRequest, a, b);
  }
};
_WatchTxRequest.runtime = import_protobuf8.proto3;
_WatchTxRequest.typeName = "utxorpc.v1alpha.watch.WatchTxRequest";
_WatchTxRequest.fields = import_protobuf8.proto3.util.newFieldList(() => [
  { no: 1, name: "predicate", kind: "message", T: TxPredicate2 },
  { no: 2, name: "field_mask", kind: "message", T: import_protobuf8.FieldMask },
  { no: 3, name: "intersect", kind: "message", T: BlockRef2, repeated: true }
]);
var WatchTxRequest = _WatchTxRequest;
var _AnyChainTx2 = class _AnyChainTx2 extends import_protobuf8.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf8.proto3.util.equals(_AnyChainTx2, a, b);
  }
};
_AnyChainTx2.runtime = import_protobuf8.proto3;
_AnyChainTx2.typeName = "utxorpc.v1alpha.watch.AnyChainTx";
_AnyChainTx2.fields = import_protobuf8.proto3.util.newFieldList(() => [
  { no: 1, name: "cardano", kind: "message", T: Tx, oneof: "chain" }
]);
var AnyChainTx2 = _AnyChainTx2;
var _WatchTxResponse = class _WatchTxResponse extends import_protobuf8.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf8.proto3.util.equals(_WatchTxResponse, a, b);
  }
};
_WatchTxResponse.runtime = import_protobuf8.proto3;
_WatchTxResponse.typeName = "utxorpc.v1alpha.watch.WatchTxResponse";
_WatchTxResponse.fields = import_protobuf8.proto3.util.newFieldList(() => [
...
var WatchService = {
  ...
  methods: {
    ...
    watchTx: {
      ...
      I: WatchTxRequest,
      O: WatchTxResponse,
      kind: import_protobuf9.MethodKind.ServerStreaming
    }
  }
};
