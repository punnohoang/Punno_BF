...
* @returns {string}
*/
export function js_validate_tx(tx_hex: string, validation_context: string): string;
/**
* @param {string} tx_hex
* @param {JsVecString} resolved_utxos
* @returns {WasmResult}
...
* @returns {any}
*/
export function decode_plutus_program_uplc_json(hex: string): any;
/**
* @param {string} tx_hex
* @returns {string}
*/
...
* @returns {any}
*/
export function check_block_or_tx_signatures(hex_str: string): any;
/**
* @param {string} tx_hex
* @returns {(string)[]}
*/
...
* @returns {any}
*/
export function execute_tx_scripts(tx_hex: string, utxo_json: any, cost_models_json: any): any;
/**
...
* @returns {any}
*/
export function decode_specific_type(input: string, type_name: string, params_json: any): any;
/**
* @param {string} input
* @returns {(string)[]}
*/
