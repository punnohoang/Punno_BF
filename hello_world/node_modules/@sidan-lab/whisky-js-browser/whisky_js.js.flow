 ...
 * @returns {string}
 */
declare export function js_validate_tx(
  tx_hex: string,
 ...
 * @returns {any}
 */
declare export function cbor_to_json(cbor_hex: string): any;

/**
 * @param {string} hex
 * @returns {string}
 */
declare export function decode_plutus_program_pretty_uplc(hex: string): string;

/**
 * @param {string} hex
 * @returns {any}
 */
declare export function decode_plutus_program_uplc_json(hex: string): any;

/**
 * @param {string} tx_hex
 * @returns {string}
 */
declare export function get_necessary_data_list_js(tx_hex: string): string;
 ...
 * @returns {string}
 */
declare export function validate_transaction_js(
  tx_hex: string,
  validation_context: string
): string;
 ...
 * @returns {any}
 */
declare export function check_block_or_tx_signatures(hex_str: string): any;

/**
 * @param {string} tx_hex
 * @returns {(string)[]}
 */
declare export function get_utxo_list_from_tx(tx_hex: string): string[];
 ...
 * @returns {any}
 */
declare export function execute_tx_scripts(
  tx_hex: string,
  utxo_json: any,
  cost_models_json: any
): any;
 ...
 * @returns {(string)[]}
 */
declare export function get_decodable_types(): string[];
 ...
 * @returns {any}
 */
declare export function decode_specific_type(
  input: string,
  type_name: string,
  params_json: any
): any;
 ...
 * @returns {(string)[]}
 */
declare export function get_possible_types_for_input(input: string): string[];
